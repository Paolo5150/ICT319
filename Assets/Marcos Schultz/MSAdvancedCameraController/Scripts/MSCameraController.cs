...
public class MSACC_SettingsCameraOrbital {
	...
	[Header("Limits")]
	[Range(3.0f,50.0f)][Tooltip("In this variable, you can set the minimum distance that the orbital camera can stay from the player.")]
	...
	[Range(-85,50)][Tooltip("In this variable it is possible to define the minimum angle that the camera can reach on the Y axis")]
